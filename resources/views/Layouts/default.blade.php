         ...
         <ul class="navbar-nav ml-auto">
               <li class="nav-item">
                  <a class="nav-link" href="#" role="button">
                     <img src="../asset/img/admin-icon.jpg" class="img-circle" alt="User Image" width="40" style="margin-top: -8px;">
                  </a>
               </li>
            <li class="nav-item">
               ...
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                  data-accordion="false">
                     <li class="nav-item">
                        <a href="{{ route('dashboard') }}" class="nav-link">
                           <img src="../asset/img/dashboard-icon.jpg" width="30" style="border-radius: 100px;">
                           <p style="color: white;">
                              Dashboard
                           </p>
                        </a>
                  ...
                  <li class="nav-item">
                     <a href="#" class="nav-link">
                        <img src="../asset/img/trans.jpg" width="30" style="border-radius: 50px;">
                        <p style="color: white;">
                           Transactions
                        </p>
               ...
               <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                     <a href="index.html" class="nav-link">
                        <img src="../asset/img/form-icon.jpg" width="30" style="border-radius: 100px;">
                        <p style="color: white;">
                           Registration Form
                        </p>
                     </a>
